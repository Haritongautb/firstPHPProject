...
var data = {
    labels: JSON.parse(decodeURIComponent(document.getElementById("label-data").value)),
    datasets: [{
        label: 'Currencies',
        data: JSON.parse(decodeURIComponent(document.getElementById("data-2").value)),
...
function getCurrencies() {
    request("/server/getCurrentValues.php", "GET")
        .then(res => {
            currenciesData = res;
